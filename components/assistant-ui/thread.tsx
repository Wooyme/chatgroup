...
const ThreadCopyContext = createContext({
  welcomeTitle: "今天想讨论什么？",
...
export const Thread: FC<ThreadProps> = ({
  ...
  return (
    <ThreadComponentsContext.Provider value={components}>
      <ThreadCopyContext.Provider value={{ welcomeTitle, composerPlaceholder }}>
        <ThreadRoot isEmpty={isEmpty} />
      </ThreadCopyContext.Provider>
...
const ThreadMessage: FC = () => {
  ...
  const hidden = useAuiState((s) => s.message.metadata?.custom?.hidden === true);
...
const ThreadWelcome: FC = () => {
  const { welcomeTitle } = useContext(ThreadCopyContext);
...
const Composer: FC = () => {
  const { composerPlaceholder } = useContext(ThreadCopyContext);
